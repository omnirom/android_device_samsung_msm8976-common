...
public class DeviceSettings extends PreferenceActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mMdnieSenario.setOnPreferenceChangeListener(new MDNIEScenario());
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mMdnieSenario) {
            Log.i(TAG, "onPreferenceChange called in DeviceSettings");
            String sValue = (String) newValue;
            mMdnieSenario.setValueIndex(Integer.valueOf(MDNIEScenario.getIndex(this)));
//            mMdnieSenario.setSummary(mMdnieSenario.getEntries()[Integer.parseInt(MDNIEScenario.getIndex(this))]);
            mMdnieSenario.setSummary(mMdnieSenario.getEntries()[Integer.parseInt((String) newValue)]);
        }
        return true;
    }
}
