...
//        }
    ...
    public boolean isWakeEvent(KeyEvent event){
        ...
        boolean bHomeButtonWake = Settings.System.getIntForUser(mContext.getContentResolver(), 
                    Settings.System.BUTTON_EXTRA_KEY_MAPPING, 1, UserHandle.USER_CURRENT) == 1;

        Log.i(TAG, "bHomeButtonWake=" + bHomeButtonWake);
        if (bHomeButtonWake){
