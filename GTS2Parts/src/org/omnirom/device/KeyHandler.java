    ...
    private class SettingsObserver extends ContentObserver {
        ...
        public void update() {
            ...
            mHomeButtonWakeEnabled = Settings.System.getIntForUser(
                    mContext.getContentResolver(), Settings.System.BUTTON_EXTRA_KEY_MAPPING, 1,
...
//            doHandleSliderAction(2);
    ...
    public boolean handleKeyEvent(KeyEvent event) {
        Log.i(TAG, "handleKeyEvent called - scancode=" + event.getScanCode() + " - keyevent=" + event.getAction());
...
//        return ArrayUtils.contains(sSupportedGestures, event.getScanCode());
    ...
    public boolean isDisabledKeyEvent(KeyEvent event) {
        Log.i(TAG, "isDisabledKeyEvent called");
...
//        }
    ...
    public boolean isWakeEvent(KeyEvent event){
        Log.i(TAG, "isWakeEvent called - scancode=" + event.getScanCode() + " - keyevent=" + event.getAction());
        if (event.getAction() != KeyEvent.ACTION_UP) {
            return false;
        }
        Log.i(TAG, "mHomeButtonWakeEnabled=" + mHomeButtonWakeEnabled);
        if (mHomeButtonWakeEnabled){
            Log.i(TAG, "bHomeButtonWake == true");
            if (event.getScanCode() == KEY_HOME) {
                Log.i(TAG, "KEY_HOME pressed");
                return true;
            }
        } else {
            Log.i(TAG, "bHomeButtonWake == flase");
        }
        return false;
    }
